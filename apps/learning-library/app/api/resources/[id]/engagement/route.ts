...
import { personalProfile, resourceEngagementSignalSchema } from "@/lib/domain";
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const engagement = await recordResourceEngagement(personalProfile.id, id, input.signal, repository);
